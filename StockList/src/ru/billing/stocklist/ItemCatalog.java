...
public class ItemCatalog {
    ...
    //c)	public ru.billing.stocklist.GenericItem findItemByID(int id) : производит поиск в каталоге по переданному id товара. Поиск следует производит в коллекции catalog типа HashMap
